...
Анализирует коммиты (поддерживает Conventional Commits и неформальные сообщения), генерирует структурированный CHANGELOG и красивые release notes. Работает локально через Docker, поддерживает внешнюю AI-интеграцию для создания улучшенной версии release notes (в MVP реализовано через GitHub Models).
...
- 📊 Автоматически анализирует git-историю 
